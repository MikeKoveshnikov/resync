...
public class ResyncDialog extends TitleAreaDialog {
	...
	private static final int BUTTON_WIDTH_HINT = 120;
	private static final int ERROR_LABLE_X_HINT = 150;
	private static final int LIST_COLUMN_SPAN = 3;
    ...
    private void createContents(final Shell shell) {  	
	    ...
	    shell.setLayout(new GridLayout(NUM_COLUMNS, false));
        ...
        final Label validationErrorLabel = new Label(shell, SWT.NONE);
	    ...
	    data = new GridData(GridData.FILL_HORIZONTAL);
	    data.horizontalSpan = LIST_COLUMN_SPAN;
	    ...
	    data.widthHint = BUTTON_WIDTH_HINT;
